...
import com.example.drive.mapper.NotTestProjectItemMapper;
import com.example.drive.mapper.NotTestProjectItemSubMapper;
...
@RestController
@RequestMapping("/notTestProject")
public class NotTestProjectController {

	@Autowired
	private NotTestProjectItemMapper projectItemMapper;
	@Autowired
	private NotTestProjectMapper projectMapper;
	@Autowired
	private NotTestProjectService projectService;
	@Autowired
	private NotTestProjectItemSubMapper projectItemSubMapper;
	@Autowired
	private FileUploadConfig fileUploadConfig;
	@Autowired
	private NotTestTerraceMapper terraceMapper;
	...
	public R info(Long projectId) {
		...
		IPage<NotTestProject> projectIPage=projectService.selectListInfo(new Page<>(1, 1),new QueryWrapper<NotTestProject>()
				.eq( "p.id", projectId)
	...
	@GetMapping("/save")
	public R save(NotTestProject project) {

		Integer count = projectMapper.selectCount(new QueryWrapper<NotTestProject>()
...
//	@GetMapping("/saveItem")
//	public R saveItem(NotTestProjectItemSub projectItemSub) {
//
//		NotTestProject project = projectMapper.selectById(projectItemSub.getProjectId());
//		projectItemSub.setTerraceId(project.getTerraceId());
//
//
//		//判断是否相同，相同则替换
//		NotTestProjectItemSub dbItem = projectItemSub.selectOne(new QueryWrapper<NotTestProjectItemSub>()
...
//	}
	...
	public R<Page> getProjectList(Integer page, Integer limit, String projectName,
		...
		IPage<NotTestProject> projectIPage=projectService.selectListInfo(new Page<>(page, limit),new QueryWrapper<NotTestProject>()
